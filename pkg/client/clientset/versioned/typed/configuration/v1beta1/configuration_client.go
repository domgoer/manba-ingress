...
import (
	...
	"github.com/domgoer/manba-ingress/pkg/client/clientset/versioned/scheme"
...
func (c *ConfigurationV1beta1Client) ManbaIngresses(namespace string) ManbaIngressInterface {
	return newManbaIngresses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ConfigurationV1beta1Client, error) {
	...
	return &ConfigurationV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new ConfigurationV1beta1Client for the given config and
...
func New(c rest.Interface) *ConfigurationV1beta1Client {
	return &ConfigurationV1beta1Client{c}
}
